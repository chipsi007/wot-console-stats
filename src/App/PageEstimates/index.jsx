    ...
    return( <nav className='panel'>
      ...
      <p className='panel-tabs'>
        <a onClick={ () => this.setState({typeFilter: null}) }
          className={ (this.state.typeFilter === null) ? 'is-active' : '' }
        >All
        </a>
        <a onClick={ () => this.setState({typeFilter: 'lightTank'}) }
          className={ (this.state.typeFilter === 'lightTank') ? 'is-active' : '' }
        >LT
        </a>
        <a onClick={ () => this.setState({typeFilter: 'mediumTank'}) }
          className={ (this.state.typeFilter === 'mediumTank') ? 'is-active' : '' }
        >MT
        </a>
        <a onClick={ () => this.setState({typeFilter: 'heavyTank'}) }
          className={ (this.state.typeFilter === 'heavyTank') ? 'is-active' : '' }
        >HT
        </a>
        <a onClick={ () => this.setState({typeFilter: 'AT-SPG'}) }
          className={ (this.state.typeFilter === 'AT-SPG') ? 'is-active' : '' }
        >AT-SPG
        </a>
        <a onClick={ () => this.setState({typeFilter: 'SPG'}) }
          className={ (this.state.typeFilter === 'SPG') ? 'is-active' : '' }
        >SPG
        </a>
      </p>
